...
INSERT INTO clients (name, full_name, inn, address, pc_id) VALUES
  ...
  ('ООО "Маг"', 'Общество с ограниченной ответственностью Магазин', 2222222222, 'г.Нижний Новгород', 100007);

INSERT INTO orders (org_id, cli_id, total, date, time) VALUES
  (100024, 100025, 750, '2017-08-28', '12:00:00');
